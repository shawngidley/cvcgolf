...
INSERT INTO golfers (name, salary, owgr, tier) VALUES
  ...
  ('Wyndham Clark', 13, 94, 'Bargain'),
  ('Dylan Wu', 13, 95, 'Bargain'),
  ('Kevin Tway', 13, 96, 'Bargain'),
  ('Parker Coody', 13, 97, 'Bargain'),
  ('Patrick Fishburn', 13, 98, 'Bargain'),
  ('Paul Peterson', 13, 99, 'Bargain'),
  ('Davis Thompson', 13, 100, 'Bargain'),
  ('Chris Gotterup', 13, 101, 'Bargain'),
  ('Rico Hoey', 13, 102, 'Bargain'),
  ('Mac Meissner', 13, 103, 'Bargain'),
  ('Nate Lashley', 13, 104, 'Bargain'),
  ('Henrik Norlander', 13, 105, 'Bargain'),
  ('Greyson Sigg', 13, 106, 'Bargain'),
  ('Matt Wallace', 13, 107, 'Bargain'),
  ('Danny Willett', 13, 108, 'Bargain'),
  ('Victor Perez', 13, 109, 'Bargain'),
  ('Nicolai Hojgaard', 13, 110, 'Bargain')
