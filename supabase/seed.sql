...
INSERT INTO tournaments (week_number, name, short_name, course, location, start_date, end_date, purse_millions, is_major, is_signature, is_complete, is_current, sort_order) VALUES
  (1, 'WM Phoenix Open', 'Phoenix', 'TPC Scottsdale (Stadium)', 'Scottsdale, AZ', '2026-02-05', '2026-02-08', 9.20, FALSE, FALSE, TRUE, FALSE, 1),
  ...
  (13, 'PGA CHAMPIONSHIP', 'PGA Champ', 'Aronimink Golf Club', 'Newtown Square, PA', '2026-05-14', '2026-05-17', 19.00, TRUE, FALSE, FALSE, FALSE, 13),
  (14, 'CJ Cup Byron Nelson', 'Byron Nelson', 'TPC Craig Ranch', 'McKinney, TX', '2026-05-21', '2026-05-24', 9.90, FALSE, FALSE, FALSE, FALSE, 14),
  (15, 'Charles Schwab Challenge', 'Colonial', 'Colonial Country Club', 'Fort Worth, TX', '2026-05-28', '2026-05-31', 9.50, FALSE, FALSE, FALSE, FALSE, 15),
  (16, 'The Memorial', 'Memorial', 'Muirfield Village GC', 'Dublin, OH', '2026-06-04', '2026-06-07', 20.00, FALSE, TRUE, FALSE, FALSE, 16),
  (17, 'Canadian Open', 'Canadian', 'Hamilton Golf & CC', 'Hamilton, ON', '2026-06-11', '2026-06-14', 9.80, FALSE, FALSE, FALSE, FALSE, 17),
  ...
  (23, 'Rocket Mortgage Classic', 'Rocket', 'Detroit Golf Club', 'Detroit, MI', '2026-07-30', '2026-08-02', 9.60, FALSE, FALSE, FALSE, FALSE, 23),
  (24, 'Wyndham Championship', 'Wyndham', 'Sedgefield Country Club', 'Greensboro, NC', '2026-08-06', '2026-08-09', 8.20, FALSE, FALSE, FALSE, FALSE, 24),
